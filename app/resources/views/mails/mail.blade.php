...
>
  ...
  >
    <div class="es-wrapper-color" style="background-color: #eeeeee;">
      ...
      <![endif]-->
      <div style="width: 600px; margin: auto; background: #e2dfdf;">
        <a
          target="_blank"
          href="'.URL::to('/').'"
          style="
        ...
        >
          ...
          <img
            src="assets/images/xycdi11704.png" alt="logo"
            style="
              display: block;
              border: 0;
              outline: none;
                          ...
                          <tr style="border-collapse: collapse;">
                            ...
                            >
                              ...
                              <h3
                                ...
                                "
                              >
                                Detalles de su Orden: {{$referencia}}.
                              </h3>
                              ...
                              @foreach($productos as $producto)
                                <tr>
                                  <td align="left">
                                   ...
                                   <img
                                      style="width: 120px;"
                                      src='{{ Voyager::image($producto->image) }}'
                                    />
                                    </td>
                                    <td>  
                                     {{$producto->name}}
